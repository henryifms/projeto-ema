 ...
 */
var require_react_is_development$1 = /* @__PURE__ */ __commonJSMin(
  (exports) => {
    (function () {
      "use strict";
 ...
 * LICENSE file in the root directory of this source tree.
 */
var require_checkPropTypes = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
 ...
 * LICENSE file in the root directory of this source tree.
 */
var require_factoryWithTypeCheckers = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
...
var ReCAPTCHA = /* @__PURE__ */ (function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ import_react.createElement(
      "div",
      _extends$1({}, childProps, { ref: this.handleRecaptchaRef }),
    );
  };
  return ReCAPTCHA;
...
var import_hoist_non_react_statics_cjs = /* @__PURE__ */ __toESM(
...
function makeAsyncScript(getScriptURL, options) {
  ...
  return function wrapWithAsyncScript(WrappedComponent) {
    ...
    var AsyncScriptLoader = /* @__PURE__ */ (function (_Component) {
      ...
      _proto.asyncScriptLoaderHandleLoad = function asyncScriptLoaderHandleLoad(
        state,
      ) {
        var _this2 = this;
          ...
          function callObserverFuncAndRemoveObserver(func) {
            if (SCRIPT_MAP[scriptURL]) {
              ...
              for (var obsKey in observersMap)
                if (func(observersMap[obsKey])) delete observersMap[obsKey];
            }
          };
    ...
    var ForwardedComponent = (0, import_react.forwardRef)(
      function (props, ref) {
    ...
    ForwardedComponent.propTypes = {
      asyncScriptOnLoad: import_prop_types.default.func,
    };
    return (0, import_hoist_non_react_statics_cjs.default)(
      ForwardedComponent,
      WrappedComponent,
    );
  };
