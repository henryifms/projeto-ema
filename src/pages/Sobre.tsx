...
import { FaGithub, FaLinkedin, FaUniversity, FaChartLine, FaUsers, FaExternalLinkAlt } from "react-icons/fa";
...
const integrantes = [
  {
    ...
    descricao: "Responsável pela arquitetura do sistema, integração de APIs e visualização de dados.",
  ...
  },
  {
    ...
    descricao: "Gerencia a coleta de dados, manutenção das estações e infraestrutura de banco de dados.",
    ...
    <div className="min-h-screen flex bg-gradient-to-br from-green-50 to-white text-gray-800">
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-green-100">
            ...
            <p className="text-gray-600">
              ...
              integrando conhecimento em meteorologia e desenvolvimento de software.
            </p>
          </div>
          <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-green-100">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-md mb-12 border-l-8 border-green-500">
          <h2 className="text-2xl font-semibold mb-3 text-green-700">Sobre o EMA</h2>
          <p className="text-gray-700 leading-relaxed">
            ...
            usabilidade e escalabilidade. Através de uma API robusta e um frontend
            moderno, o projeto permite que pesquisadores, agricultores e o público
            geral acompanhem condições meteorológicas em tempo real, além de
            previsões horárias. A plataforma suporta múltiplas estações, gestão
            de usuários e análise histórica de dados.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {integrantes.map((pessoa, idx) => (
            ...
            >
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-800">{pessoa.nome}</h3>
                <p className="text-green-600 font-medium mt-1">{pessoa.funcao}</p>
                <p className="text-gray-500 text-sm mt-2 mb-4">{pessoa.descricao}</p>
